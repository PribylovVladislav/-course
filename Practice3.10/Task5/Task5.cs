namespace Task5
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Число загадно. " +
                "Вводите числа и попытайтесь угадать его." +
            ...
            while (true)
            {
                ...
                if (inputNumber < randomNumber) 
                    Console.WriteLine("Число меньше задуманного");
                else if (inputNumber > randomNumber) 
                    Console.WriteLine("Число больше задуманного");
                else
                {
